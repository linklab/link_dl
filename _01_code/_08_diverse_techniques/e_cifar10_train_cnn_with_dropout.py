...
if __name__ == "__main__":
  ...
  main(args)
  # python _01_code/_08_diverse_techniques/e_cifar10_train_cnn_with_dropout.py --dropout --wandb -v 1 -w 0.002
  # python _01_code/_08_diverse_techniques/e_cifar10_train_cnn_with_dropout.py --no-dropout --wandb -v 1 -w 0.002
