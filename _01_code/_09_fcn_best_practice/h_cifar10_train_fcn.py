...
if __name__ == "__main__":
  ...
  main(args)
  # python _01_code/_09_fcn_best_practice/h_cifar10_train_fcn.py --wandb -b 2048 -r 1e-3 -v 10
  # python _01_code/_09_fcn_best_practice/h_cifar10_train_fcn.py --no-wandb -b 2048 -r 1e-3 -v 10
