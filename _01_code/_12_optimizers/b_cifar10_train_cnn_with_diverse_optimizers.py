...
if __name__ == "__main__":
  ...
  main(args)
  # python _01_code/_12_optimizers/b_cifar10_train_cnn_with_diverse_optimizers.py --wandb -o 0 -v 1
  # python _01_code/_12_optimizers/b_cifar10_train_cnn_with_diverse_optimizers.py --wandb -o 1 -v 1
  # python _01_code/_12_optimizers/b_cifar10_train_cnn_with_diverse_optimizers.py --wandb -o 2 -v 1
  # python _01_code/_12_optimizers/b_cifar10_train_cnn_with_diverse_optimizers.py --wandb -o 3 -v 1