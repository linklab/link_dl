...
from _01_code._09_fcn_best_practice.i_cifar10_test_fcn import get_cifar10_test_data
from _01_code._16_modern_cnns._03_google_net.a_cifar10_train_google_net import get_google_net_model
...
def main():
  ...
  test_model = torchvision.models.googlenet(num_classes=10) if USE_PYTORCH_MODEL else get_google_net_model(num_classes=10)
