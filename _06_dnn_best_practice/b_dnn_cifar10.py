...
def get_data():
  ...
  train_data_loader = DataLoader(
    dataset=transformed_cifar10, batch_size=wandb.config.batch_size, shuffle=True, num_workers=2
  )
  validation_data_loader = DataLoader(
    dataset=transformed_cifar10_val, batch_size=wandb.config.batch_size, num_workers=2
  )
